...
<head>
	...
	<title>Kapal Selam Telur Asin - Pempek Ummi</title>
			...
			<div class="col-md-9 col-md-push-3">
				<div class="box">
					<div class="box-header">
						<h3 class="box-titel">Kapal Selam Telur Asin</h3>
						<div class="box-tools" id="letaknavproduk"></div>
					</div>
					<div class="box-body">
						<div class="owl-carousel slider-produk owl-theme">
							<?php $ambil = $koneksi->query("SELECT * FROM menumakanan WHERE id_kategori = '3' "); ?>

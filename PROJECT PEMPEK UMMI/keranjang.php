...
<head>
	...
	<title>Keranjang - Pempek Ummi</title>
			...
			<div class="col-md-9 col-md-push-3">
				...
				<div class="box">
					...
					<div class="box-body">
						<div class="table-responsive">
							<table class="table table-bordered table-hover table-striped">
								...
								<tbody>
									...
									<?php $ambil=$koneksi->query("SELECT * FROM menumakanan WHERE id_menu='$id_produk' "); 
						...
						<a href="checkout.php" class="btn btn-primary col-md-offset-8"><i class="fa fa-chevron-circle-right"></i> Checkout</a>
					</div>
				</div>
			...
			<div class="col-md-3 col-md-pull-9">
				...
				<div class="panel panel-color">
					...
					<div class="list-group">
						...
						<a href="Udang Galah.php" class="list-group-item"><i class="fas fa-utensils"></i></i>Kapal Selam Telur Asin</a>
				</div>

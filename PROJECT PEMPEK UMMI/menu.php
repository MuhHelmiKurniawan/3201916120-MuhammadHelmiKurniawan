...
<head>
	...
	<title>Menu Makanan - Pempek Ummi</title>
			...
			<div class="col-md-9 col-md-push-3">
				<div class="box">
					<div class="box-header">
						<h3 class="box-titel">Menu Makanan</h3>
					</div>
					<div class="box-body">
						<div class="row">
							<?php $ambil = $koneksi->query("SELECT * FROM menumakanan"); ?>
							<?php while($perproduk=$ambil->fetch_assoc()){ ?>
							<div class="col-md-4 mb20">
								<div class="image-product">
									<img src="foto_produk/<?php echo $perproduk['foto_menu']; ?>"
									 class="img-responsive" >
								</div>
								<h3 class="title-product"><?php echo $perproduk['nama_menu']; ?></h3>

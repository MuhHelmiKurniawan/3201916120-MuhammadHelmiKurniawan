		...
		<div class="row">
			<div class="col-md-9 col-md-push-3">
				...
				<div class="owl-carousel slider-utama">
					<?php $ambil = $koneksi->query("SELECT * FROM slider ORDER BY tanggal_slider DESC LIMIT 5"); ?>
					<?php while($perslider=$ambil->fetch_assoc()){ ?>
					<div>
						<img src="foto_slider/<?php echo $perslider['foto_slider']; ?>" alt="" width="100" height="700">
					</div>
					<?php } ?>
				</div>
				<!-- area slider Akhir -->
				...
				<div class="infobox">
					<div class="row">
						<div class="col-md-4 infobox-item text-center">
							<h3 class="infobox-title">Jangkauan Area</h3>
							<span class="infobox-text">Melayani pembelian untuk daerah Sanggau dan Sekitarnya</span>
						</div>
						<div class="col-md-4 infobox-item text-center">
							<h3 class="infobox-title">Ongkos Kirim</h3>
							<span class="infobox-text">Untuk daerah Sanggau dan Sekitarnya dikenakan ongkos pengiriman Rp. 5,000</span>
						</div>
						<div class="col-md-4 infobox-item text-center">
							<h3 class="infobox-title">Harga Termurah</h3>
							<span class="infobox-text">Jaminan harga termurah di bandingkan toko lain</span>
						</div>
					</div>
				</div>
